...
import { SuccessResponse, ErrorResponse, StatusCodes, ErrorCodes } from "../response/base";
...
OauthController.post('/authenticate', AuthValidator.login(), Authentication, authHandler);
